...
export default function MeowfiCard({ index }: { index: number }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="shadow-yellow h-20 border-x-2 border-t-2 border-white px-1.5 pt-0.25 shadow-[0_-4px_4px]">
        <img className="h-full border border-white" src="/images/logo.webp" />
      </div>
